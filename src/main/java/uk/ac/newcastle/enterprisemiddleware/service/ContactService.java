...
import uk.ac.newcastle.enterprisemiddleware.util.InvalidAreaCodeException;
import uk.ac.newcastle.enterprisemiddleware.repository.ContactRepository;
import uk.ac.newcastle.enterprisemiddleware.validator.ContactValidator;
...
public class ContactService {
    ...
    public Contact create(Contact contact) throws Exception {
        ...
        try {
            //Removed temporarily due to non-existing AreaService
             Area area = areaController.getAreaById(Integer.parseInt(contact.getPhoneNumber().substring(1, 4)));
